  ...
  try {
    ...
    if (detection.hasChanged) {
      ...
      const newCard = {
        ...
        affects_product: analysis.affects_product ? 1 : 0,
        impact_type: analysis.impact_type || 'No Direct Impact',
        affected_product_areas: analysis.affected_product_areas || '',
        battlecard_counter: analysis.battlecard_counter || '',
        churn_risk: analysis.churn_risk || 'Low',
        market_position_risk: analysis.market_position_risk || 1,
        screenshot_path: scrapeResult.screenshotPath,
