...
export default function CommandPalette({ 
  ...
  return (
    <div className="mira-modal-backdrop" onClick={onClose}>
      <div 
        className="w-full max-w-xl bg-[#0D111A]/95 border border-white/10 rounded-2xl shadow-2xl overflow-hidden backdrop-blur-2xl animate-in fade-in zoom-in-95 duration-200"
